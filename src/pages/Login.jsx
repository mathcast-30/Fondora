...
export default function Login() {
    ...
    return (
        <div className="relative min-h-screen bg-[#0a1f33] text-white flex items-center justify-center p-6 overflow-hidden font-sans">
            ...
            {/* Fond animé */}
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#10b981]/15 rounded-full blur-[120px] animate-pulse"></div>
            <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-500/15 rounded-full blur-[150px]"></div>
            ...
            <div className="relative z-10 w-full max-w-md bg-[#122a44]/60 border border-slate-700 backdrop-blur-xl rounded-3xl p-8 shadow-2xl shadow-[#10b981]/5">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-xl font-bold mt-3 text-white">Ravi de vous revoir</h2>
                    <p className="text-slate-400 text-sm mt-1">Connectez-vous pour accéder à votre espace sécurisé.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <button type="button" className="text-xs text-[#10b981] hover:text-[#34d399] font-medium transition-colors">Oublié ?</button>
                        </div>
                        <input
                            type="password"
                            required
                ...
                <p className="text-center text-sm text-slate-400 mt-6">
                    Nouveau sur Fondora ?{' '}
                    <button onClick={() => navigate('/signup')} className="text-[#10b981] hover:text-[#34d399] font-semibold transition-colors">Créer un compte</button>
                </p>
            </div>
        </div>
    );
